			...
			<div className="right">
				<div className="tit-wrap">
					...
					<p>
						안녕하세요, 저는 조소미입니다. 😀
						<br />
						새로운 기술에 관심이 많으며 동료들과의 커뮤니케이션과 상호 피드백 및 리뷰를 좋아합니다. 현재 백엔드 개발자로 구직중입니다. 맡은 일에 자부심을 갖고 도전을 경험할 수 있는 회사에서 일하고 싶습니다.
					</p>
				</div>
				<section>
					...
					<ul>
						...
						<li>
							<span>Age : </span>31, 1992.06
						</li>
						<li>
							<span>Phone : </span>010.3457.9954
						</li>
						<li>
							<span>Address : </span>인천광역시 서구
						</li>
						<li>
